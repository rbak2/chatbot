...
responses = {
    ...
    "філо": {"рід": Grammar, "род": Grammar, "час": Tense, "pres": Tense, "пит": Question, "some": Some,
             "Default": Default},
    "фізи": {"енер": Energy, "бойл": Boyle, "Default": Default},
    "геог": {"вод": Reservoir, "корд": Country, "Default": Default},
    "зага": {"пора": Season, "рік": Year, "цита": Quotes, "числ": Random, "Default": Default},
    "текс": {"лати": Latin, "цифр": Numbers, "звор": Reverse, "верх": Upper, "Default": Default},
    "інфо": {"інфо": Response1, "комп": Response2, "інте": Response3, "коду": Response4,
             "алго": Response5, "блок": Response6, "прог": Response7, "числ": Response8, "Default": Default}}
